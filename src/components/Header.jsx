...
const Header = () => {
  ...
  const filteredProducts = (e) => {
    ...
    if (input.value === "") {
      ...
      const filterlanganData = data.filter((item) => {
        return item.name.toLowerCase().includes(input.value.toLowerCase());
      });
      setProductData(filterlanganData);
    }
  };
            ...
            <div className="py-3">
              <div className="flex flex-col items-center md:flex-row xl:justify-between lg:justify-between md:justify-between sm:justify-between xl:px-5 lg:px-5 md:px-5 sm:px-5">
                ...
                <div className="flex flex-col relative w-full md:w-[350px] xl:w-[360px] mb-2 md:mb-0">
                  <form
                    className="flex sm:mx-auto mx-auto"
                    onSubmit={(e) => {
                      e.preventDefault();
                      filteredProducts(e);
                    }}
                      ...
                      {productData &&
                        productData.map((product) => (
                          <li
                            ...
                            >
                            <Link 
                            className="inline-block w-full py-2 hover:bg-gray-100"
